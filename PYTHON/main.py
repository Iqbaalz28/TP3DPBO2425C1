...
def main():
    ...
    uni.add_student(Student("S002","Ani",21,"2102","SI",3.60))
    ...
    uni.add_ta(TeachingAssistant("TA001","Andi",22,"2201","Informatika",3.80,
    ...
    for i in range(n):
        ...
        if pilihan == 1:
            ...
            uni.add_ta(TeachingAssistant(id,nama,usia,nim,jurusan,gpa,nidn,departemen,jabatan,jam))
